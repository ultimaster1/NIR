...
int size_out1=35;//2 por ahora anadir mas mas adelantes
int size_out2=35;//2 por ahora nadir mas mas afelante
int size_out3=35;//2 por ahora nadir mas mas afelante
int out;
bool primero=true;
...
//   printf (allstring);
   ...
   string sep=",";
   ushort u_sep;                  // codigo del separador
   string result[];               // array para obtener cadenas
   //--- obtenemos el codigo del separador
